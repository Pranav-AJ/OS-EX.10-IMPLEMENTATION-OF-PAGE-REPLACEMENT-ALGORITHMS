...
## OUTPUT:
![image](https://github.com/Pranav-AJ/OS-EX.10-IMPLEMENTATION-OF-PAGE-REPLACEMENT-ALGORITHMS/assets/118904526/7eb9fa95-c109-44d5-8b3e-88d018010a76)
...
5. Compare all frames with incoming page6. If the incoming page is already available in page frame, 
   set the match flag to indicate ‘no need of page replacement’.
...
```
## OUTPUT
![image](https://github.com/Pranav-AJ/OS-EX.10-IMPLEMENTATION-OF-PAGE-REPLACEMENT-ALGORITHMS/assets/118904526/99e79f77-f26c-428b-8f89-b8a5a5a2dc0d)
...
3. Look for the page allocated is present in near future, if no then replace
   that page in the memory with new page,
...
```
## OUTPUT
![image](https://github.com/Pranav-AJ/OS-EX.10-IMPLEMENTATION-OF-PAGE-REPLACEMENT-ALGORITHMS/assets/118904526/cbbc2abe-1c01-4954-bec9-c15fc71a5102)
